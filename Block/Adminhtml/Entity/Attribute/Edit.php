...
class Edit extends Container
{
     ...
     * @var string
     */
    protected $_blockGroup = 'Ainnomix_EntityTypeManager';

    protected $_objectId = 'attribute_id';

    protected $_controller = 'adminhtml_entity_attribute';
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('entity_attribute')->getId()) {
            ...
            return __('Edit Entity Attribute "%1"', $this->escapeHtml($frontendLabel));
        }
        return __('New entity Attribute');
    }
